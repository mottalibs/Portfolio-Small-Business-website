    ...
    <div className="bento-card justify-between h-full group">
      ...
      <div className="mt-8 pt-4 border-t border-[var(--border)] flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <FaCircle size={8} className="text-[var(--accent-2)] animate-pulse" />
          <span className="text-mono text-[0.7rem] font-bold text-[var(--accent-2)]">
             {mode === 'cyberpunk' ? 'ACTIVE' : 'Available'}
          </span>
        </div>
      </div>
    </div>
